...
@section('content')
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal"
                            data-bs-target="#tambahGuruModal">Tambah Guru</button>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($gurus as $guru)
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $guru->role }}</td>
    ...
    <!-- Modal Tambah Guru -->
    <x-modal :id="'tambahGuruModal'" :title="'Tambah Guru'" :user="'guruModal'">
    ...
    <!-- Modal Edit Guru -->
    @foreach ($gurus as $guru)
        <x-modal :id="'editGuruModal' . $guru->id" :title="'Edit Guru'" :user="'guruModal'">
