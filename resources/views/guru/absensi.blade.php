            ...
            <div class="col-md-10">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        @elseif($isMinggu)
                            <div class="alert alert-warning">Hari ini adalah <strong>Minggu</strong>. Absensi tidak
                                tersedia.</div>
                        @elseif($isHariLibur)
                            <div class="alert alert-warning">Hari ini adalah <strong>hari libur nasional</strong>. Absensi
                                tidak tersedia.</div>
                        @else
                        ...
                        <div class="mt-4 text-center">
                            <a href="{{ route('guru.absensi.riwayat') }}" class="btn btn-outline-primary">
